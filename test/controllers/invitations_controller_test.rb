...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { email: @invitation.email, family_id: @invitation.family_id, uuid: @invitation.uuid } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { email: @invitation.email, family_id: @invitation.family_id, uuid: @invitation.uuid } }
